.. currentmodule:: Arithmos.data.storage

##########################
Data Storage (``storage``)
##########################

:obj:`Arithmos.data.storage.Storage` is an abstract class representing a data object
...
(:obj:`Arithmos.data.Domain`), the three parts correspond to lists of variable
...
There are currently two derived classes :obj:`Arithmos.data.Table` and
:obj:`Arithmos.data.sql.Table`, the former storing the data in-memory, in numpy
...
rows that match the criteria given in the filter. :obj:`Arithmos.data.Table`
implements an efficient method based on numpy indexing, and
:obj:`Arithmos.data.sql.Table`, which "stores" a table as an SQL query, converts
the filter into a WHERE clause.

.. attribute:: domain (:obj:`Arithmos.data.Domain`)
...
.. method:: __getitem__(self, index)
    ...
    - If the index is an int, e.g. `data[7]`; the corresponding row is
      returned as an instance of :obj:`~Arithmos.data.instance.Instance`. Concrete
...
:obj:`Arithmos.data.Table` executes them directly through numpy (or bottleneck
or related) methods, while :obj:`Arithmos.data.sql.Table` appends them to the
...
:obj:`Arithmos.data.filter`. Methods in :obj:`Arithmos.data.filter` also provide
...
.. method:: _filter_is_defined(self, columns=None, negate=False)
    ...
    :type negate: bool
    :return: a new storage of the same type or :obj:`~Arithmos.data.Table`
    :rtype: Arithmos.data.storage.Storage
...
.. method:: _filter_same_value(self, column, value, negate=False)
    ...
    :type column: int, str or Arithmos.data.Variable
...
.. method:: _filter_values(self, filter)
    ...
    :type filter: Arithmos.data.Filter
    :return: a new storage of the same type or :obj:`~Arithmos.data.Table`
    :rtype: Arithmos.data.storage.Storage
...
within :obj:`Arithmos.statistics`.
...
.. automethod:: Arithmos.data.storage.Storage._compute_contingency
