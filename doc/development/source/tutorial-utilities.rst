...
Class `Arithmos.widgets.gui.ProgressBar` is initialized with a widget and the
number of iterations::

    progress = Arithmos.widgets.gui.ProgressBar(self, n)
...
* :obj:`~Arithmos.widgets.widget.OWWidget.progressBarInit(self)`
* :obj:`~Arithmos.widgets.widget.OWWidget.progressBarSet(self, p)`
* :obj:`~Arithmos.widgets.widget.OWWidget.progressBarFinished(self)`
...
:attr:`~Arithmos.widgets.widget.OWWidget.info` namespace using the
:func:`~Arithmos.widgets.widget.StateInfo.set_input_summary` and
:func:`~Arithmos.widgets.widget.StateInfo.set_output_summary` methods.
::
...
.. seealso::
   :func:`~Arithmos.widgets.widget.StateInfo.set_input_summary`,
   :func:`~Arithmos.widgets.widget.StateInfo.set_output_summary`
...
:obj:`~Arithmos.widgets.widget.Message`. The messages contains a text and an
