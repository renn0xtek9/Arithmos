...
**Tree** is a simple algorithm that splits the data into nodes by class purity. It is a precursor to [Random Forest](../model/randomforest.md). Tree in Arithmos is designed in-house and can handle both discrete and continuous datasets.
